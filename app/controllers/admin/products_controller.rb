class Admin::ProductsController < Admin::AdminController
  ...
  def product_params
    params.require(:product).permit(:complex_name, :barcode, :code, :size_id, :quantity, :price, :item_id, :img,  :price_with_helium, item_attributes: [:color_id, :category_id, :texture_id, :tone_id, :foil_form_id, :type_id, subcategory_ids: []])
  end
