  ...
  def show
    ...
    when 'день рождения'
      set_meta_tags title: "Заказать оформление воздушными шарами на день рождения по выгодным ценам в Ижевске в компании Шариковая Фея",
                    ...
                    reverse: true
    when 'свадьба'
      set_meta_tags title: "Оформление юбилеев воздушными шарами, украшение зала в Ижевске в компании Шариковая Фея",
                    description: "Оформить зал воздушными шарами на свадьбу в Ижевске по недорогой цене вам поможет компания Шариковая Фея",
                    reverse: true
    when 'юбилей'
      set_meta_tags title: "Заказать оформление воздушными шарами на свадьбу в Ижевске  в компании Шариковая Фея",
                    description: "Заказать оформление зала на юбилей в Ижевске в компании Шариковая Фея",
                    reverse: true
    when '8 марта'
      set_meta_tags title: "Украшение воздушными шарами на 8 Марта в Ижевске в компании Шариковая Фея",
                    description: "Оформить воздушными шарами 8 Марта в Ижевске в компании Шариковая Фея",
                    reverse: true
    else
