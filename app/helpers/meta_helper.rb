module MetaHelper
	...
	def set_meta_tags_for_main
		keywords = "доставка воздушных шаров #{@city},
	                              ...
	                              доставка шаров #{@city},
	                              шары гелий #{@city},
	                              шары в %{city}е где купить,
	                              заказать гелевые шары в %{city}" % {city: t("cities.#{@city}.where")}
	  description = "Оформление торжества воздушными шарами от Шариковой феи оставит приятные впечатления и сделает этот день ярким. Для оформления заказа звоните по телефону %{phone}" % {phone: t("cities.#{@city}.phone.mobile")}
	  case params[:action]
		when "index"
			set_meta_tags title: "Доставка и оформление воздушными шарами в %{city} от Шариковой феи" % {city: t("cities.#{@city}.where")},
	...
	def set_meta_og
		set_meta_tags og: {
      title: "Доставка и оформление воздушными шарами в #{@city}е от Шариковой феи",
