...
ActiveRecord::Schema.define(version: 20_171_215_072_023) do
  ...
  create_table 'images', force: :cascade do |t|
    ...
    t.datetime 'updated_at',       null: false
    t.string   'style'
    t.index %w[imageable_type imageable_id], name: 'index_images_on_imageable_type_and_imageable_id', using: :btree
  end
  ...
  create_table 'items_subcategories', id: false, force: :cascade do |t|
    ...
    t.index %w[item_id subcategory_id], name: 'index_items_subcategories_on_item_id_and_subcategory_id', using: :btree
  end
  ...
  create_table 'receivers', force: :cascade do |t|
    ...
    t.string  'slug'
    t.index %w[personable_type personable_id], name: 'index_receivers_on_personable_type_and_personable_id', using: :btree
  ...
  create_table 'tags', force: :cascade do |t|
    ...
    t.index %w[taggable_type taggable_id], name: 'index_tags_on_taggable_type_and_taggable_id', using: :btree
  end
