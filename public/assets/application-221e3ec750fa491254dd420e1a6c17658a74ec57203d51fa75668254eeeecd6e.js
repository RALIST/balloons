...
$(document).on('click', '.fa#more', function(){
  $('body').animate({
    scrollTop: $('#outdoor').offset().top - 30 }, 'slow')
});
...
$(document).on('click', '#icon-wrapper', function(){
  ...
  $('.resp-menu-bar').toggleClass('bg-brand bg-transparent', 300);
});
...
var yandex_map = function(){
  ...
  function init(){
      myMap = new ymaps.Map("map", {
          center: [56.841067, 53.118398],
          zoom:14,
          controls: []
      });

      balloonContentHeader = "<b style='font-size: 16px;'>Мы здесь!</b><br>";
      balloonContentBody = '<img style="width: 100px;" src="/assets/logo2-41e3bb3b9f0e140da4fb207629f9e0d3cf4e47c92449f238cc638347cf44c74b.png" alt="Logo2" /><br>';
      balloonContentFooter = "ул. Николая Островского, 25";

      balloon = "<div class='text-center'>" + balloonContentHeader + balloonContentBody + balloonContentFooter + "</div>";

      myPlacemark = new ymaps.Placemark([56.841067, 53.118398], {
          balloonContentHeader: "Мы здесь!",
          balloonContentBody: '<img style="width: 60px;" src="/assets/logo2-41e3bb3b9f0e140da4fb207629f9e0d3cf4e47c92449f238cc638347cf44c74b.png" alt="Logo2" />',
          balloonContentFooter: "ул. Николая Островского, 25",
          hintContent: "Шариковая фея"
      });

      myMap.balloon.open([56.841067, 53.118398], balloon, {
...
$(document).ready(function() {
  if ($('.pagination').length) {
    $(window).scroll(function() {
      ...
      if (url && $(window).scrollTop() > $('.wrapper').height() - $(window).height() - 50) {
