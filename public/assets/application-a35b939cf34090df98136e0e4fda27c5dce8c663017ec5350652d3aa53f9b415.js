...
$(document).on('mouseenter touchstart', '[data-product-id], [data-item-id]' , function(){
  $('[data-item-id] a, [data-item-id] span, [data-product-id] a, [data-product-id] span').each(function(index, value){
    element = $(value)
    element.popover({
      trigger: 'hover',
      placement: 'bottom',
...
<!-- Yandex.Metrika counter -->
    (function (d, w, c) {
        (w[c] = w[c] || []).push(function() {
            try {
                w.yaCounter37371855 = new Ya.Metrika({
                    id:37371855,
                    clickmap:true,
                    trackLinks:true,
...
(window.Image ? (new Image()) : document.createElement('img')).src = location.protocol + '//vk.com/rtrg?r=VDk2X3ZdR9E*K1K43ZJxAOsIQpaAH*uG5yTx9uv/Bzr1Kk3QPgvfm9I0P7dqVmM1N4q6Mq*dfHk30XcZHe5R04pKHQ2keQOEt9s/e4JdtYEjNQr6GjlrV5vCJE*fUe3ZDusLcHKwoE3U17jqFR5UKe9K94m4Q7ETly9xxqaxnX4-&pixel_id=1000010867';
(function() {
...
$(document).on('click touch', '#toggle-search-bar, #close-bar', function(){
  $('.search-bar').toggle('drop').toggleClass('toggled');
});
...
$(document).on('ready', function(){
  $('#size-slider').slider({
    ...
    create: function(event, ui){
      $('input#min').val($('#size-slider').slider('values', 0));
      $('input#max').val($('#size-slider').slider('values', 1));
    },
    stop: function(){
      $('input#min').val($('#size-slider').slider('values', 0));
      $('input#max').val($('#size-slider').slider('values', 1));
  ...
  $('input#min_size').on('change', function(){
    var min_value = $(this).val();
    var max_value = $('#max_size').val();
    if(parseInt(min_value) > parseInt(max_value)){
      min_value = max_value;
      $(this).val(min_value)
    }
    $('#size-slider').slider('values', 0, min_value)
  });

  $('input#max_size').on('change', function(){
    var max_value = $(this).val();
    var min_value = $('#min_size').val();
    if(parseInt(max_value) > 90){max_value = 90; $(this).val(max_value)}
    if(parseInt(min_value) > parseInt(max_value)) {
      max_value = min_value;
      $(this).val(max_value);
    }
    $('#size-slider').slider('values', 1, max_value)
  });
});
